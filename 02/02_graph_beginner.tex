...
\begin{frame}{\insertsection: \insertsubsection}
  ...
  \begin{columns}[t]
    \begin{column}{0.3\linewidth}
      \begin{block}{木}
        \centering
        \includegraphics[width=\linewidth]{res/tree-crp.pdf}
      \end{block}
    \end{column}
    \hfill
    \begin{column}{0.3\linewidth}
      \begin{block}{木でない}
        \centering
        \includegraphics[width=\linewidth]{res/tree-cycle-crp.pdf}
        閉路を持つ
      \end{block}
    \end{column}
    \hfill
    \begin{column}{0.3\linewidth}
      \begin{block}{木でない}
        \centering
        \includegraphics[width=\linewidth]{res/forest-crp.pdf}
        連結でない
      \end{block}
    \end{column}
  \end{columns}
